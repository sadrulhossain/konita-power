...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-certificate"></i>@lang('label.CERTIFICATE_LIST')
            </div>
            <div class="actions">
                @if(!empty($userAccessArr[43][2]))
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center vcenter">
                                ...
                                <img class="pictogram-min-space tooltips" width="50" height="50" src="{{URL::to('/')}}/public/img/certificate/{{ $target->logo }}" alt="{{ $target->name}}" title="{{ $target->name }}"/>
                                @else 
                            ...
                            <td class="td-actions text-center vcenter">
                                <div class="width-inherit">
                                    @if(!empty($userAccessArr[43][3]))
                                    <a class="btn btn-xs btn-primary tooltips" title="Edit" href="{{ URL::to('certificate/' . $target->id . '/edit'.Helper::queryPageStr($qpArr)) }}">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    @endif
                                    
                                    @if(!empty($userAccessArr[43][4]))
                                    {{ Form::open(array('url' => 'certificate/' . $target->id.'/'.Helper::queryPageStr($qpArr), 'class' => 'delete-form-inline')) }}
