...
<div class="col-md-12">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-certificate"></i>@lang('label.CREATE_CERTIFICATE')
            </div>
        </div>
        <div class="portlet-body form">
            {!! Form::open(array('group' => 'form', 'url' => 'certificate','files' => true,'class' => 'form-horizontal')) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="clearfix margin-top-10">
                                    <span class="label label-danger">@lang('label.NOTE')</span> @lang('label.CERTIFICATE_IMAGE_FOR_IMAGE_DESCRIPTION')
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
