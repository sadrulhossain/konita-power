                ...
                <div class="table-responsive max-height-500 webkit-scrollbar">
                    <table class="table table-bordered table-hover relation-view-2">
                        ...
                        <tbody id="exerciseData">
                            ...
                            <?php
                            $rowspan = !empty($brandRelatedToSupplier[$product['id']]) ? count($brandRelatedToSupplier[$product['id']]) : 1;
                            ...
                            <tr>
                                ...
                                @if(!empty($brandRelatedToSupplier[$product['id']]))
                                <?php $i = 0; ?>
                                @foreach($brandRelatedToSupplier[$product['id']] as $relatedBrandId)
                            ...
                            <tr>
                                <td colspan="5" class="text-danger">
                                    @lang('label.NO_RELATED_PRODUCT_FOUND_FOR_THIS_SUPPLIER')
                                </td>
                            </tr>
                            @endif      
                        </tbody>
