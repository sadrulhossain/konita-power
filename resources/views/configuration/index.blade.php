                ...
                <div class="col-md-12">
                    <div class="tabbable-line">
                        <ul class="nav nav-tabs ">
                            <li class="active" >
                                <a href="#tab_15_1" data-toggle="tab"> @lang('label.SIGNATORY_INFORMATION') </a>
                            </li>

                            <li>
                                <a href="#tab_15_2" data-toggle="tab"> @lang('label.COMPANY_INFORMATION') </a>
                            </li>
                        </ul>
                                        ...
                                        <div class="row">
                                            <div class="col-md-offset-1 col-md-7">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        {!! Form::textarea('address',  __('label.KONITA_ADDRESS'), ['id'=> 'address', 'class' => 'form-control','autocomplete' => 'off']) !!} 
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on("click", ".add-phone-number", function () {
            $.ajax({
                url: "{{ URL::to('configuration/addPhoneNumber')}}",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).on("click", "#saveCompanyInfo", function (e) {
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        url: "{{ URL::to('configuration/saveCompanyInfo')}}",
                        type: 'POST',
                        cache: false,
                        contentType: false,
                        processData: false,
