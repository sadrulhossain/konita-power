...
<tr>
    ...
    <td class="text-center vcenter width-240">
        <div class="input-group bootstrap-touchspin width-inherit">
            <span class="product-select-span-{{$v4}}">
                {!! Form::select('product['.$v4.'][product_id]', $productList, null, ['id'=> 'productProductId_'.$v4, 'data-key' => $v4, 'class' => 'form-control product-select js-source-states']) !!}
            </span>
    ...
    <td class="text-center vcenter width-240">
        <div class="input-group bootstrap-touchspin width-inherit">
            <span class="brand-select-span-{{$v4}}">
                {!! Form::select('product['.$v4.'][brand_id]', $brandList, null, ['id'=> 'productBrandId_'.$v4, 'data-key' => $v4, 'class' => 'form-control brand-select js-source-states']) !!}
            </span>
    ...
    <td class="text-center vcenter width-240">
        <div class="input-group bootstrap-touchspin width-inherit">
            <span class="grade-select-span-{{$v4}}">
                {!! Form::select('product['.$v4.'][origin_id]', $countryList, null, ['id'=> 'originId_'.$v4, 'data-key' => $v4, 'class' => 'form-control grade-select js-source-states']) !!}
            </span>
        </div>
    </td>
    ...
    <td class="text-center vcenter width-80">
        {!! Form::text('product['.$v4.'][unit]', null, ['id'=> 'productUnit_'.$v4, 'data-key' => $v4, 'class' => 'form-control width-inherit product-unit']) !!}
    </td>
