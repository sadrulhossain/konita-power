<div class="modal-content">
    <div class="modal-header clone-modal-header">
        ...
        <h3 class="modal-title text-center">
            @lang('label.PENDING_ODRED_CANCELLATION')
        </h3>
    </div>
    <div class="modal-body">
        <div class="row">
            <div class="col-md-12">
                {!! Form::open(array('group' => 'form', 'class' => 'form-horizontal', 'files' => true,'id' => 'pendingOrderCencelForm')) !!}
        ...
        <div class="modal-footer">
            <div class="row">
                <div class="col-md-12">
                    <button class="btn btn-inline green" type="button" id='submitPendingOrderCancel'>
