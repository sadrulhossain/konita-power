...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-database"></i>@lang('label.SOURCE_LIST')
            </div>
            <div class="actions">
                @if(!empty($userAccessArr[68][2]))
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('crmSource/create'.Helper::queryPageStr($qpArr)) }}"> @lang('label.CREATE_NEW_SOURCE')
        ...
        <div class="portlet-body">
            <div class="row">
                <!-- Begin Filter-->
                {!! Form::open(array('group' => 'form', 'url' => 'crmSource/filter','class' => 'form-horizontal')) !!}
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                ...
                                <datalist id="search">
                                    @if(!empty($nameArr))
                                    @foreach($nameArr as $sourceName)
                                    <option value="{{$sourceName->name}}"></option>
                                    @endforeach
                                    @endif
                                </datalist>
                            </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="td-actions text-center vcenter">
                                <div class="width-inherit">
                                    ...
                                    <a class="btn btn-xs btn-primary tooltips" title="Edit" href="{{ URL::to('crmSource/' . $target->id . '/edit'.Helper::queryPageStr($qpArr)) }}">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    @endif
                                    @if(!empty($userAccessArr[68][4]))
                                    {{ Form::open(array('url' => 'crmSource/' . $target->id.'/'.Helper::queryPageStr($qpArr), 'class' => 'delete-form-inline')) }}
                        ...
                        @else
                        <tr>
                            <td colspan="8">@lang('label.NO_SOURCE_FOUND')</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
