...
<html>
    ...
    <body>      
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr class="blue-light">
                                        ...
                                        <th class="text-center vcenter bold font-size-11">@lang('label.INVOICE')</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th class="text-center vcenter blue-dark bold font-size-14" colspan="4">@lang('label.PREVIOUS_BALANCE')</th>
                                        <th class="vcenter blue-grey font-size-14 text-right">${!! !empty($previousBalance) ? Helper::numberFormat2Digit($previousBalance) : Helper::numberFormat2Digit(0) !!}</th>
                                    </tr>
                                    @endif
                                    ...
                                    @endforeach
                                    <tr>
                                        <th class="text-right vcenter blue-dark bold font-size-11" colspan="4">@lang('label.NET_BALANCE')=</th>
        <!--                                    <th class="vcenter blue-grey text-right">${!! !empty($totalBilled) ? Helper::numberFormat2Digit($totalBilled) : Helper::numberFormat2Digit(0) !!}</th>
                                        ...
                                        <th class="vcenter blue-grey text-right font-size-11">${!! !empty($totalBalance) ? Helper::numberFormat2Digit($totalBalance) : Helper::numberFormat2Digit(0) !!}</th>
                                    </tr>
                                    @else
                                    <tr>
