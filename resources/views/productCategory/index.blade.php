                ...
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="vcenter text-center">@lang('label.HAS_MACHINE')</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="vcenter text-center">
                                @if($target->has_machine == '1')
                                <span class="label label-sm label-green-sharp">@lang('label.YES')</span>
                                @else
                            ...
                            <td class="td-actions text-center vcenter">
                                <div class="width-inherit">
                                    ...
                                    {{ Form::open(array('url' => 'productCategory/' . $target->id.'/'.Helper::queryPageStr($qpArr), 'class' => 'delete-form-inline')) }}
