<div class="modal-content">
    <div class="modal-header clone-modal-header">
        <div class="col-md-7 text-right">
            <h4 class="modal-title">@lang('label.CANCELLED_ORDER_DETAILS')</h4>
        </div>
        <div class="col-md-5">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-6">
                        <table class="table table-borderless">
                            ...
                            <tr>
                                <td class="bold" width="50%">@lang('label.CAUSE_OF_FAILURE')</td>
                                <td width="50%">
                                    {!! $causeList[$orderInfo->order_cancel_cause] ?? '' !!}
                                </td>
                            </tr>        
                        </table>
                    </div>
                ...
                <div class="table-responsive  div-box-default">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            ...
                            <td colspan='11' class="vcenter">{!! !empty($orderInfo->note)?$orderInfo->note:'' !!}</td>
                        </tr>
                    </table>
                </div>
            </div>
