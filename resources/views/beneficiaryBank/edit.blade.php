...
<div class="col-md-12">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-bank"></i>@lang('label.EDIT_BENEFICIARY_BANK')
            </div>
        </div>
        <div class="portlet-body form">
            {!! Form::model($target, ['route' => array('beneficiaryBank.update', $target->id), 'method' => 'PATCH','class' => 'form-horizontal'] ) !!}
