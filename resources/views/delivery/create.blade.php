...
<div class="col-md-12">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-truck"></i>@lang('label.CREATE_DELIVERY')
            </div>
        </div>
        <div class="portlet-body form">
            {!! Form::open(array('group' => 'form', 'url' => 'delivery', 'class' => 'form-horizontal','files' => true)) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div id="loadTotalQuantity">
                            {!! Form::text('total_quantity', null, ['id'=> 'totalQuantity', 'class' => 'form-control integer-only','autocomplete' => 'off', 'disabled']) !!} 
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div id="loadRemainingQuantity">
                            {!! Form::text('remain_quantity', null, ['id'=> 'remainingQuantity', 'class' => 'form-control integer-only','autocomplete' => 'off', 'disabled']) !!} 
