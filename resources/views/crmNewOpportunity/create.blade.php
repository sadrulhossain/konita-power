...
<div class="col-md-12">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-list"></i>@lang('label.CREATE_NEW_OPPORTUNITY')
            </div>
        </div>
        <div class="portlet-body form">
            {!! Form::open(array('group' => 'form', 'url' => '', 'id' => 'newOppornunityCreateForm','class' => 'form-horizontal')) !!}
            {!! Form::hidden('page', Helper::queryPageStr($qpArr)) !!}
            {!! Form::hidden('sales_person_id', Auth::user()->id, ['id' => 'salesPersonId']) !!}
            {!! Form::hidden('sales_person_group_id', Auth::user()->group_id, ['id' => 'salesPersonGroupId']) !!}
            {!! Form::hidden('status', 1, ['id' => 'statusId']) !!}
            {{csrf_field()}}
            <div class="form-body">
                <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group bootstrap-touchspin">
                                    <span class="buyer-select-span">
                                        {!! Form::select('buyer_id', $buyerList, null, ['id'=> 'buyerId', 'class' => 'form-control buyer-select js-source-states']) !!}
                                    </span>
                                    <!--{!! Form::text('buyer_name',null, ['id'=> 'buyerName', 'class' => 'form-control buyer-text','autocomplete' => 'off']) !!}--> 
    <!--                                    <span class="input-group-addon label-blue-steel padding-0 border-0 bootstrap-touchspin-postfix bold">
                                        <button class="btn btn-sm blue-steel buyer-text-btn bold tooltips" title="@lang('label.CLICK_TO_TYPE_AS_TEXT')" type="button">
                                            <i class="fa fa-text-height bold"></i> 
                                        </button>
                                        <button class="btn btn-sm blue-steel buyer-select-btn bold tooltips display-none" title="@lang('label.CLICK_TO_SELECT_FROM_DROPDOWN')" type="button">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                {!! Form::textarea('address', null, ['id'=> 'address', 'class' => 'form-control', 'autocomplete' => 'off', 'size' => '20x3',]) !!} 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                {!! Form::select('buyer_contact_person', $buyerContPersonList, null, ['class' => 'form-control js-source-states', 'id' => 'buyerContactPerson']) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                {!! Form::select('source_id', $sourceList, null, ['class' => 'form-control js-source-states', 'id' => 'sourceId']) !!} 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                {!! Form::textarea('remarks', null, ['id'=> 'remarks', 'class' => 'form-control', 'autocomplete' => 'off', 'size' => '20x3',]) !!} 
...
//        });
        ...
        $(document).on("click", "#crmOpportunityCreateSubmit", function (e) {
            ...
            $.ajax({
                url: "{{route('crmNewOpportunity.store')}}",
                type: "POST",
                dataType: 'json', // what to expect back from the PHP script, if anything
                cache: false,
                contentType: false,
                ...
                success: function (res) {
                    ...
                    setTimeout(
                            window.location.replace('{{ route("crmNewOpportunity.index")}}'
                                    ), 7000);
