...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on('change', '#productId', function (e) {
            ...
            $('#showGrade').html('');
            $.ajax({
                url: "{{ URL::to('lead/rwBreakdownGetBrand')}}",
                type: "POST",
                dataType: "json",
                headers: {
        ...
        $(document).on('change', '#brandId', function (e) {
            ...
            $('#showRwBreakdownView').html('');
            $.ajax({
                url: "{{ URL::to('lead/rwBreakdownGetGrade')}}",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).on('change', '#gradeId', function (e) {
            ...
            $('#showRwBreakdownView').html('');
            $.ajax({
                url: "{{ URL::to('lead/getRwBreakdownView')}}",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
// Serialize the form data
            ...
            $.ajax({
                url: "{{ URL::to('lead/rwProceedRequest') }}",
                type: "POST",
...
// Serialize the form data
            var formData = new FormData($('#proceedForm')[0]);
            $.ajax({
                url: "{{ URL::to('lead/rwProceedRequestEdit') }}",
                type: "POST",
                dataType: 'json', // what to expect back from the PHP script, if anything
                cache: false,
                contentType: false,
...
// Serialize the form data
            ...
            $.ajax({
                url: "{{ URL::to('lead/rwPreviewRequest') }}",
                type: "POST",
                dataType: 'json', // what to expect back from the PHP script, if anything
                cache: false,
                contentType: false,
...
// Serialize the form data
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        url: "{{ URL::to('lead/rwBreakDownSave') }}",
                        type: "POST",
                        dataType: 'json', // what to expect back from the PHP script, if anything
                        cache: false,
                        contentType: false,
...
// Serialize the form data
            ...
            $.ajax({
                url: "{{ URL::to('lead/getLeadRwParametersName') }}",
                type: "POST",
                dataType: 'json', // what to expect back from the PHP script, if anything
                data: {
                    rw_unit_id: rwParaId,
