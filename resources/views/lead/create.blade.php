...
<div class="col-md-12">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-user"></i>@lang('label.CREATE_NEW_INQUIRY')
            </div>
        </div>
        <div class="portlet-body form">
            {!! Form::open(array('group' => 'form', 'class' => 'form-horizontal', 'files' => true,'id' => 'leadForm')) !!}
            {!! Form::hidden('filter', Helper::queryPageStr($qpArr)) !!}

            {!! Form::hidden('per_unit',null, ['id' => 'perUnit']) !!}
            {{csrf_field()}}
            <div class="form-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <div class="col-md-3">
                                ...
                                <div class="input-group date datepicker2" data-date-end-date="+0d">
                                    {!! Form::text('creation_date', $currentDate, ['id'=> 'creationDate', 'class' => 'form-control', 'placeholder' =>'DD MM YYYY', 'readonly' => '','autocomplete' => 'off']) !!} 
                            ...
                            <div class="col-md-3 margin-top-10">
                                <div class="mt-radio-inline">
                                    <label class="mt-radio">
                                        <input type="radio" name="shipment_address_status" id="shipmentAddress1" value="1" checked> @lang('label.HEAD_OFFICE')
                                        <span></span>
                                    </label>
                                    <label class="mt-radio">
                                        <input type="radio" name="shipment_address_status" id="shipmentAddress2" value="2"> @lang('label.FACTORY')
                                        <span></span>
                                    </label>
                                </div>
                            </div>
            ...
            <div class="form-body">
                <!--                <div class="row">
                                    <div class="col-md-12 md-checkbox has-success">
                                        {!! Form::checkbox('add_first_followup',1,null, ['id' => 'addFirstFollowup', 'class'=> 'md-check']) !!}
                                        <label for="addFirstFollowup">
                                            <span class="inc"></span>
                                            <span class="check mark-caheck"></span>
                                            <span class="box mark-caheck"></span>
                                        </label>
                                        <span class="text-success">@lang('label.ADD_FIRST_FOLLOWUP_FOR_THIS_INQUIRY')</span>
                                    </div>
                                </div>-->
                <div class="row margin-top-10 first-followup-block">
                    <!--                    <div class="col-lg-4 col-md-4 col-sm-5 col-xs-12 margin-bottom-10">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <button class="btn btn-sm bold blue-steel tooltips vcenter choose-opportunity" title="@lang('label.CLICK_TO_CHOOSE_OPPORTUNITY')" href="#modalChooseOpportunity" data-id="0" data-toggle="modal">
                                                        @lang('label.CHOOSE_OPPORTUNITY')
                                                    </button>
                                                    <button class="btn btn-sm bold yellow tooltips vcenter opportunity-details" title="@lang('label.CLICK_TO_VIEW_OPPORTUNITY_DETAILS')" href="#modalOpportunityDetails" data-id="0" data-toggle="modal">
                                                    ...
                                                    {!! Form::hidden('opportunity_id', 0, ['id'=>'opportunityId']) !!}
                                                </div>
                                            </div>
                                        </div>-->
                    <div class="col-md-offset-2 col-lg-offset-2 col-sm-offset-2 col-lg-6 col-md-6 col-sm-5 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                {!! Form::select('followup_status', $followupStatusList, null, ['class' => 'form-control js-source-states ','id'=>'followupStatus']) !!}
