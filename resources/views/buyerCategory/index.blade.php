...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-list"></i>@lang('label.BUYER_CATEGORY_LIST')
            </div>
            <div class="actions">
                @if(!empty($userAccessArr[10][2]))
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('buyerCategory/create'.Helper::queryPageStr($qpArr)) }}"> @lang('label.CREATE_NEW_BUYER_CATEGORY')
        ...
        <div class="portlet-body">
            <div class="row">
                <!-- Begin Filter-->
                {!! Form::open(array('group' => 'form', 'url' => 'buyerCategory/filter','class' => 'form-horizontal')) !!}
                <div class="row">
                    <div class="col-md-4">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="td-actions text-center vcenter">
                                <div class="width-inherit">
                                    ...
                                    <a class="btn btn-xs btn-primary tooltips vcenter" title="Edit" href="{{ URL::to('buyerCategory/' . $target->id . '/edit'.Helper::queryPageStr($qpArr)) }}">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    @endif
                                    @if(!empty($userAccessArr[10][4]))
                                    {{ Form::open(array('url' => 'buyerCategory/' . $target->id.'/'.Helper::queryPageStr($qpArr), 'class' => 'delete-form-inline')) }}
                        ...
                        @else
                        <tr>
                            <td colspan="8">@lang('label.NO_BUYER_CATEGORY_FOUND')</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
