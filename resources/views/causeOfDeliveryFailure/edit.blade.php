...
<div class="col-md-12">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-balance-scale"></i>@lang('label.EDIT_CAUSE_OF_DELIVERY_FAILURE')
            </div>
        </div>
        <div class="portlet-body form">
            {!! Form::model($target, ['route' => array('causeOfDeliveryFailure.update', $target->id), 'method' => 'PATCH', 'class' => 'form-horizontal'] ) !!}
