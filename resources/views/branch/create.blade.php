...
<div class="col-md-12">
    <div class="portlet box green">
        ...
        <div class="portlet-body form">
            {!! Form::open(array('group' => 'form', 'url' => 'branch', 'class' => 'form-horizontal', 'files' => true)) !!}
...
<script type="text/javascript">
    $(function () {
        ...
        $(document).on('change', '#countryId', function () {
            ...
            $.ajax({
                url: '{{URL::to("branch/getDivisionToCreate/")}}',
                type: 'POST',
                dataType: 'json',
                headers: {
        ...
        $(document).on('change', '#divisionId', function () {
            ...
            $.ajax({
                url: '{{URL::to("branch/getDistrictToCreate/")}}',
                type: 'POST',
                dataType: 'json',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).on('change', '#districtId', function () {
            ...
            $.ajax({
                url: '{{URL::to("branch/getThanaToCreate/")}}',
                type: 'POST',
                dataType: 'json',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
