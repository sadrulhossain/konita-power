<div class="modal-content">
    <div class="modal-header clone-modal-header">
        <div class="col-md-7 text-right">
            <h4 class="modal-title">@lang('label.VOID_OPPORTUNITY')</h4>
        </div>
        <div class="col-md-5">
    ...
    <div class="modal-body">
        ...
        {!! Form::open(array('group' => 'form', 'url' => '', 'class' => 'form-horizontal', 'id' => 'opportunityVoidForm')) !!}
        {{csrf_field()}}
            ...
            <div class="row">
                <div class="col-md-offset-2 col-md-7">
                    <div class="form-group">
                        <label class="control-label col-md-4" for="voidRemarks">@lang('label.REMARKS') :<span class="text-danger"> *</span></label>
                        <div class="col-md-8">
                            {!! Form::textarea('void_remarks', null, ['id'=> 'voidRemarks', 'class' => 'form-control','autocomplete' => 'off','rows' => 4, 'cols' => 40,]) !!} 
                            <span class="text-danger">{{ $errors->first('void_remarks') }}</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-footer">
        ...
        <button type="button" class="btn grey-cascade"  id="voidOpportunity">
            <i class="fa fa-ban"></i> @lang('label.SUBMIT_VOID')
        </button>
