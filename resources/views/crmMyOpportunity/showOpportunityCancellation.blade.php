<div class="modal-content">
    <div class="modal-header clone-modal-header">
        <div class="col-md-7 text-right">
            <h4 class="modal-title">@lang('label.CANCEL_OPPORTUNITY')</h4>
        </div>
        <div class="col-md-5">
            ...
            <div class="row">
                <div class="col-md-offset-2 col-md-7">
                    <div class="form-group">
                        <label class="control-label col-md-4" for="cancelRemarks">@lang('label.REMARKS') :<span class="text-danger"> *</span></label>
                        <div class="col-md-8">
                            {!! Form::textarea('cancel_remarks', null, ['id'=> 'cancelRemarks', 'class' => 'form-control','autocomplete' => 'off','rows' => 4, 'cols' => 40,]) !!} 
                            <span class="text-danger">{{ $errors->first('cancel_remarks') }}</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-footer">
        ...
        <button type="button" class="btn red-mint"  id="cancelOpportunity">
            <i class="fa fa-times"></i> @lang('label.SUBMIT_CANCEL')
        </button>
