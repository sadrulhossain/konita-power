...
<div class="col-md-12">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-cubes"></i>@lang('label.EDIT_ORDER')
            </div>
        </div>
        <div class="portlet-body form">
            {!! Form::model($target, ['route' => array('order.update', $target->id), 'method' => 'PATCH', 'files'=> true, 'class' => 'form-horizontal'] ) !!}
...
<script type="text/javascript">
    $(function () {
        $("#leadId").on("change", function () {
            var leadId = $(this).val();
            $.ajax({
                url: "{{URL::to('order/loadLcValueToEdit')}}",
                type: "POST",
                dataType: 'json',
                headers: {
