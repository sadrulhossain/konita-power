<div class="modal-content">
    <div class="modal-header clone-modal-header">
        ...
        @if($userAccessArr[17][6])
        <a class="btn green-haze pull-right tooltips vcenter margin-left-right-5" target="_blank" href="{{ URL::to('salesPersonToBuyer/getRelatedSalesPersonListPrint?buyer_id='.Request::get('buyer_id').'&view=print') }}"  title="@lang('label.CLICK_HERE_TO_PRINT')">
