...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-list"></i>@lang('label.VOID_OPPORTUNITY_LIST')
            </div>
        </div>
        <div class="portlet-body">
            <div class="row">
                <!-- Begin Filter-->
                {!! Form::open(array('group' => 'form', 'url' => 'crmVoidOpportunity/filter','class' => 'form-horizontal')) !!}
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-4">
                ...
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="vcenter text-center">@lang('label.VOID_REMARKS')</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="vcenter">{!! $target->void_remarks ?? '' !!}</td>

                            <td class="td-actions text-center vcenter">
                                <div class="width-inherit">
                                    @if(!empty($userAccessArr[76][5]))
                        ...
                        @else
                        <tr>
                            <td colspan="10">@lang('label.NO_VOID_OPPORTUNITY_FOUND')</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
...
<script type="text/javascript">
    $(function () {
        ...
        $(".opportunity-details").on("click", function (e) {
            ...
            $.ajax({
                url: "{{ URL::to('/crmVoidOpportunity/getOpportunityDetails')}}",
                type: "POST",
                dataType: "json",
                headers: {
        ...
        $(".set-activity-log").on("click", function (e) {
            ...
            $.ajax({
                url: "{{ URL::to('crmVoidOpportunity/getOpportunityActivityLogModal')}}",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
