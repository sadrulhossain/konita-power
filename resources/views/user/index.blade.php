                ...
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr class="text-center info">
                            ...
                            <th class="text-center vcenter">@lang('label.ALLOWED_FOR_SALES')</th>
                            <th class="text-center vcenter">@lang('label.AUTHORISED_FOR_REALIZATION_PRICE')</th>
                            <th class="text-center vcenter">@lang('label.ALLOWED_FOR_CRM')</th>
                            <th class="text-center vcenter">@lang('label.FOR_CRM_LEADER')</th>
                            <th class="text-center vcenter">@lang('label.ALLOWED_FOR_VIEW_QUOTATION_REQUSET')</th>
                            <th class="text-center vcenter">@lang('label.ALLOWED_FOR_MESSAGING')</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center vcenter">
                                @if($target->authorised_for_realization_price == '1')
                                <span class="label label-sm label-success">@lang('label.YES')</span>
                                @else
                                <span class="label label-sm label-warning">@lang('label.NO')</span>
                                @endif
                            ...
                            <td class="text-center vcenter">
                                @if($target->allowed_to_view_quotation == '1')
                                <span class="label label-sm label-success">@lang('label.YES')</span>
                                @else
                                <span class="label label-sm label-warning">@lang('label.NO')</span>
                                @endif
                            ...
                            <td class="text-center vcenter">
                                @if($target->allowed_for_messaging == '1')
                                <span class="label label-sm label-success">@lang('label.YES')</span>
                                @else
                                <span class="label label-sm label-warning">@lang('label.NO')</span>
                                @endif
