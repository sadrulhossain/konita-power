            ...
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 text-center">
                <div class="alert alert-danger">
                    <p>
                        ...
                        <a href="{{ URL::to('/salesPersonPaymentVoucher?sales_person_id='.$request->sales_person_id.'&approval_status=1') }}">
        ...
        <div class="form-actions">
            <div class="row">
                <div class="col-md-offset-4 col-md-8">
                    ...
                    @endif
                    @endif
                    <a href="{{ URL::to('/salesPersonPayment') }}" class="btn btn-outline grey-salsa">@lang('label.CANCEL')</a>
