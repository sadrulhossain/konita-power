<html>
    ...
    <body>
        ...
        <div class="portlet-body margin-bottom-75">
            ...
            <div class="row margin-bottom-10">
                <div class="col-md-12">
                    <div class="text-center bold uppercase">
                        <span class="inv-border-bottom">@lang('label.SALES_PERSON_PAYMENT_VOUCHER')</span>
                    </div>
                </div>
            </div>
            ...
            <div class="row margin-bottom-10">
                <div class="col-md-12">
                    <span>@lang('label.SALES_PERSON'): </span><span class="bold">{{!empty($salesPersonInfo->name)?$salesPersonInfo->name:''}}</span><br/>
                    <span>@lang('label.DESIGNATION'): </span><span class="bold">{{!empty($salesPersonInfo->designation)?$salesPersonInfo->designation:''}}</span>
                </div>
            </div>
            <div class="row margin-bottom-10">
                <div class="col-md-12">
        ...
        <div class="row margin-top-200">
            <div class="col-md-12">
                <table class="table borderless margin-top-75">
                    <tr class=" margin-top-75">
                        <td class="no-border  margin-top-200" width="70%">
                            ------------------------------<br/>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;@lang('label.RECEIVED_BY')
                        </td>
                        <td class="no-border margin-top-200" width="30%">
                            ------------------------------<br/>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;@lang('label.PAID_BY')
                        </td>
                    </tr>
