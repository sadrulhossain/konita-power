                    ...
                    <table class="table table-bordered margin-top-10">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="vcenter font-size-11" rowspan="{{$rowSpan['inquiry']}}">{!! $inquiry->order_no ?? '' !!}</td>
                                <td class="vcenter font-size-11" rowspan="{{$rowSpan['inquiry']}}">{!! $inquiry->purchase_order_no ?? '' !!}</td>
                                @if(empty($request->sales_person_id) || $request->sales_person_id == 0)
                                <td class="vcenter font-size-11" rowspan="{{$rowSpan['inquiry']}}">{!! $inquiry->sales_person ?? '' !!}</td>
                                @endif
                                <td class="vcenter font-size-11" rowspan="{{$rowSpan['inquiry']}}">{!! $inquiry->supplier ?? '' !!}</td>
                                ...
                                ?>
                                <td class="vcenter font-size-11" rowspan="{{$rowSpan['grade']}}">{!! $grade['grade_name'] ?? '' !!}</td>
                                @if(!empty($grade['gsm']))
                                <?php $l = 0 ?>
                                ...
                                ?>
                                <td class="text-right vcenter font-size-11">{!! $item['gsm'] ?? '' !!}</td>
                                <td class="text-right vcenter font-size-11">{!! $item['quantity'] ?? '' !!}</td>
                                <td class="text-right vcenter font-size-11">{!! $item['unit_price'] ?? '' !!}</td>
                                <td class="text-right vcenter font-size-11">{!! $item['total_price'] ?? '' !!}</td>

                                @if($i == 0 && $j == 0 && $k == 0)
                                <td class="text-center vcenter font-size-11" rowspan="{{$rowSpan['inquiry']}}">{!! !empty($inquiry->creation_date) ? Helper::formatDate($inquiry->creation_date) : '' !!}</td>
                                <td class="text-center vcenter font-size-11" rowspan="{{$rowSpan['inquiry']}}">{!! !empty($inquiry->pi_date) ? Helper::formatDate($inquiry->pi_date) : ''  !!}</td>
                                <td class="text-center vcenter font-size-11" rowspan="{{$rowSpan['inquiry']}}">{!! !empty($inquiry->lc_date) ? Helper::formatDate($inquiry->lc_date) : ''  !!}</td>
                                <td class="text-center vcenter font-size-11" rowspan="{{$rowSpan['inquiry']}}">{!! $inquiry->lc_no ?? '' !!}</td>
                                ...
                                <td class="text-center vcenter font-size-11" rowspan="{{$rowSpan['inquiry']}}">{!! !empty($inquiry->lc_issue_date) ? Helper::formatDate($inquiry->lc_issue_date) : ''  !!}</td>
                                <td class="text-center vcenter font-size-11" rowspan="{{$rowSpan['inquiry']}}">{!! $lsdArr[$inquiry->id] ?? '' !!}</td>
                                <td class="text-center vcenter font-size-11" rowspan="{{$rowSpan['inquiry']}}">
                            ...
                            @else
                            <tr>
                                <td class="vcenter text-danger font-size-11" colspan="{!! (empty($request->sales_person_id) || $request->sales_person_id == 0) ? 21 : 20 !!}">@lang('label.NO_DATA_FOUND')</td>
                            </tr>
                            @endif
                        </tbody>
                    </table>
