<html>
    <head>
        ...
        <link rel="shortcut icon" href="{!! public_path() !!}/public/img/favicon.ico" />
            ...
            <div class="row margin-bottom-20">
                <div class="col-md-12">
                    <div class="text-center bold uppercase">
                        <span class="inv-border-bottom font-size-11 header">@lang('label.BRAND_WISE_PURCHASE_SUMMARY_REPORT')
                            <?php
