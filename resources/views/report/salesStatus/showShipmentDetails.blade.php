<div class="modal-content">
    <div class="modal-header clone-modal-header">
        ...
        <a class="btn green-haze pull-right tooltips vcenter margin-left-right-5" target="_blank" href="{{ URL::to('salesStatusReport/getShipmentDetailsPrint?shipment_id='.Request::get('shipment_id').'&view=print') }}"  title="@lang('label.CLICK_HERE_TO_PRINT')">
