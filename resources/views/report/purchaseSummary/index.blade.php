...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-bar-chart"></i>@lang('label.PURCHASE_SUMMARY_REPORT')
            </div>
            <div class="actions">
        ...
        <div class="portlet-body">
            {!! Form::open(array('group' => 'form', 'url' => 'purchaseSummaryReport/filter','class' => 'form-horizontal')) !!}
            <div class="row">
                <div class="col-md-4">
                        ...
                        <table class="table table-bordered table-hover table-head-fixer-color" id="fixTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right vcenter">{!! (!empty($purchaseSummaryArr[$month]['volume']) ? Helper::numberFormat2Digit($purchaseSummaryArr[$month]['volume']) : Helper::numberFormat2Digit(0)) . ' ' . __('label.UNIT') !!}</td>
                                </tr>
                                @endforeach
                                <tr>
                                    <th class="text-right vcenter" colspan="2">@lang('label.TOTAL')</th>
                                    <th class="text-right vcenter">{!! (!empty($purchaseSummaryArr['total']['volume']) ? Helper::numberFormat2Digit($purchaseSummaryArr['total']['volume']) : Helper::numberFormat2Digit(0)) . ' ' . __('label.UNIT') !!}</th>
                                </tr>
                                @else
                                <tr>
                                    <td class="vcenter text-danger" colspan="3">@lang('label.NO_DATA_FOUND')</td>
                                </tr>
                                @endif
                            </tbody>
                        </table>
...
if (!empty($monthArr)) {
    foreach ($monthArr as $month => $monthName) {
        $volume = $purchaseSummaryArr[$month]['volume'] ?? 0;
        echo "'$volume',";
    }
}
?>
