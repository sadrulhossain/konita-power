...
<div class="col-md-12">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-hourglass"></i>@lang('label.EDIT_FOLLOWUP_STATUS')
            </div>
        </div>
        <div class="portlet-body form">
            {!! Form::model($target, ['route' => array('followupStatus.update', $target->id), 'method' => 'PATCH','class' => 'form-horizontal'] ) !!}
...
<script>
    $(function () {
        if ($("#color").val() == '0') {
            ...
            $("#colorDiv").removeClass().addClass("col-md-1 bg-" + $("#color").val());
        }

        if ($("#icon").val() == '0') {
            $("#iconsnap").removeClass();
        } else {
            $("#iconsnap").removeClass().addClass($("#icon").val());
        }
