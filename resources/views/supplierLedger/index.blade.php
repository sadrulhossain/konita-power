...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-list"></i>@lang('label.SUPPLIER_LEDGER')
            </div>
            <div class="actions">
        ...
        <div class="portlet-body">
            <!-- Begin Filter-->
            {!! Form::open(array('group' => 'form', 'url' => 'supplierLedger/filter','class' => 'form-horizontal')) !!}
                ...
                <div class="col-md-12">
                    <div class="bg-blue-hoki bg-font-blue-hoki">
                        <h5 style="padding: 10px;">
                            {{__('label.SUPPLIER')}} : <strong>{{ $supplierList[$request->supplier_id] ?? __('label.N_A') }} |</strong> 
