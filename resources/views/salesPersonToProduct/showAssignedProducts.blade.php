<div class="row relation-div-box-default">
    <div class="col-md-12 border-bottom-1-green-seagreen">
        <h5>
            ...
            @if(!empty($assignedProductList) && empty($dependentProductArr[$request->sales_person_id]))
            <a class="btn btn-xs bold btn-circle red-intense pull-right remove-all-assignments tooltips " title="@lang('label.CLICK_TO_REMOVE_ALL')" 
               ...
               data-sales-person-id="{{ $request->sales_person_id }}">
            ...
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if(!empty($dependentProductArr[$request->sales_person_id]) && in_array($productId, $dependentProductArr[$request->sales_person_id]))
