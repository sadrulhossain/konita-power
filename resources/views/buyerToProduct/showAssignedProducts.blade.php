<div class="row relation-div-box-default">
    <div class="col-md-12 border-bottom-1-green-seagreen">
        <h5>
            ...
            @if(!empty($assignedProductList) && empty($dependentProductArr[$request->buyer_id]))
            ...
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if(!empty($dependentProductArr[$request->buyer_id]) && in_array($productId, $dependentProductArr[$request->buyer_id]))
