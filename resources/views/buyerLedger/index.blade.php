...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-list"></i>@lang('label.BUYER_LEDGER')
            </div>
            <div class="actions">
        ...
        <div class="portlet-body">
            <!-- Begin Filter-->
            {!! Form::open(array('group' => 'form', 'url' => 'buyerLedger/filter','class' => 'form-horizontal')) !!}
                ...
                <div class="col-md-12">
                    <div class="bg-blue-hoki bg-font-blue-hoki">
                        <h5 style="padding: 10px;">
                            {{__('label.BUYER')}} : <strong>{{ !empty($buyerList[$request->buyer_id]) && $request->buyer_id != 0 ? $buyerList[$request->buyer_id] : __('label.N_A') }} |</strong> 
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="vcenter">
                                        ...
                                        @else
                                        @lang('label.REMARKS'): <span class="bold">{!! $amount['remarks'] ?? __('label.PAID_TO_BUYER') !!}</span><br/>
                                            @lang('label.BUYER_CONTACT_PERSON'): <span class="bold">{!! $amount['buyer_contact_person'] !!}</span><br/>
                                            @lang('label.PHONE'): <span class="bold">{!! $amount['buyer_contact_number'] !!}</span>
                                        @endif
...
<script type="text/javascript">
    $(function () {
        ...
        $(".shipment-details").on("click", function (e) {
            ...
            $.ajax({
                url: "{{ URL::to('/buyerLedger/shipment')}}",
                type: "POST",
                dataType: "json",
                headers: {
