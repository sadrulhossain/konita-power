<div class="modal-content">
    <div class="modal-header clone-modal-header">
        <div class="col-md-7 text-right">
            <h4 class="modal-title">@lang('label.ACCOMPLISHED_ORDER_DETAILS')</h4>
        </div>
        <div class="col-md-5">
            ...
            <div class="col-md-12">
                <div class="table-responsive  div-box-default">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            <td class="fit bold  vcenter">@lang('label.REMARKS')</td>
                            <td colspan='11' class="vcenter">{!! !empty($orderInfo->order_accomplish_remarks)?$orderInfo->order_accomplish_remarks:'' !!}</td>
                        </tr>
                    </table>
                </div>
            </div>
