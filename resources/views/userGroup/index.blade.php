    ...
    <div class="portlet box green">
        <div class="portlet-title">
            ...
            <div class="actions">
                ...
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('userGroup/create'.Helper::queryPageStr($qpArr)) }}"> @lang('label.CREATE_NEW_USER_GROUP')
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center vcenter">
                                @if($target->allowed_for_all_inquiry_access == '1')
                            ...
                            <td class="td-actions text-center vcenter">
                                <div class="width-inherit">
                                    ...
                                    {!! Form::open(array('url' => 'userGroup/' . $target->id.'/'.Helper::queryPageStr($qpArr), 'class' => 'delete-form-inline')) !!}
