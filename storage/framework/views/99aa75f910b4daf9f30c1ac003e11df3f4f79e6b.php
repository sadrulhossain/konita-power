...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-check-circle"></i><?php echo app('translator')->get('label.ACCOMPLISHED_ORDER_LIST'); ?>
            </div>
        </div>
        <div class="portlet-body">
            <!-- Begin Filter-->
            <?php echo Form::open(array('group' => 'form', 'url' => 'accomplishedOrder/filter','class' => 'form-horizontal')); ?>
                ...
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <?php if(!empty($userAccessArr[31][5])): ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="vcenter" rowspan="<?php echo e($rowSpan['inquiry']); ?>"><?php echo $target->order_accomplish_remarks; ?></td>
                            ...
                            <td class="text-center vcenter" rowspan="<?php echo e($rowSpan['inquiry']); ?>">
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php else: ?>
                                <button class="btn btn-xs btn-circle red-soft tooltips vcenter" title="<?php echo app('translator')->get('label.NO_SHIPMENT_YET'); ?>">
                            ...
                            <td class="td-actions text-center vcenter" rowspan="<?php echo e($rowSpan['inquiry']); ?>">
                                <div class="width-inherit">
                                    <!--commission setup-->
                                    <?php if(!empty($userAccessArr[31][18])): ?>
                                    ...
                                    <?php if(!empty($userAccessArr[31][17])): ?>
                                    ...
                                    <!--RW BREAKDOWN--> 
                                    <?php if(!empty($userAccessArr[31][19])): ?>
                                    <?php if(!empty($rwBreakdownStatusArr[$target->id])): ?>
                                    <a class="btn btn-xs green-soft tooltips vcenter" title="<?php echo app('translator')->get('label.RW_BREAKDOWN_EDIT'); ?>" href="<?php echo e(URL::to('accomplishedOrder/rwBreakdown/' . $target->id . Helper::queryPageStr($qpArr ?? ''))); ?>">
                                    ...
                                    <?php else: ?>
                                    <a class="btn btn-xs yellow tooltips vcenter" title="<?php echo app('translator')->get('label.RW_BREAKDOWN'); ?>" href="<?php echo e(URL::to('accomplishedOrder/rwBreakdown/' . $target->id . Helper::queryPageStr($qpArr ?? ''))); ?>">
                                        <i class="fa fa fa-external-link"></i>
                                    </a>
                                    <?php endif; ?>
                                    <?php endif; ?>
                                    ...
                                    <?php if(!empty($userAccessArr[31][13])): ?>
                        ...
                        <?php else: ?>
                        <tr>
                            <td colspan="18" class="vcenter"><?php echo app('translator')->get('label.NO_ACCOMPLISHED_ORDER_FOUND'); ?></td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
...
<script type="text/javascript">
    $(function () {
        ...
        $(".order-details").on("click", function (e) {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('/accomplishedOrder/getOrderDetails')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
        ...
        $(document).on("click", ".followup-history", function (e) {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('accomplishedOrder/getFollowUpModal')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).on("click", "#saveHistory", function (e) {
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        url: "<?php echo e(URL::to('accomplishedOrder/setFollowUpSave')); ?>",
                        type: 'POST',
                        cache: false,
                        contentType: false,
                        processData: false,
        ...
        $(document).on("click", ".rw-breakdown-view", function (e) {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('accomplishedOrder/leadRwBreakdownView')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).on("click", ".commission-setup-modal", function (e) {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('accomplishedOrder/getCommissionSetupModal')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).on("click", "#cmsnSaveBtn", function (e) {
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        url: "<?php echo e(URL::to('accomplishedOrder/commissionSetupSave')); ?>",
                        type: 'POST',
                        cache: false,
                        contentType: false,
                        processData: false,
...
//        endof commission setup
        ...
        $(document).on("click", "#quantitySummary", function (e) {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('accomplishedOrder/quantitySummaryView')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(".order-cancel").on("click", function (e) {
            ...
            var inquiryId = $(this).attr('data-id');
            $.ajax({
                url: "<?php echo e(URL::to('accomplishedOrder/orderCancellationModal')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(".shipment-details").on("click", function (e) {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('/accomplishedOrder/getShipmentDetails')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(".lead-time").on("click", function (e) {
            ...
            var inquiryId = $(this).attr("data-id");
            $.ajax({
                url: "<?php echo e(URL::to('/accomplishedOrder/getLeadTime')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp_7_4_15\htdocs\konitaPower\resources\views/accomplishedOrder/index.blade.php ENDPATH**/ ?>