                ...
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr class="text-center info">
                            ...
                            <th class="vcenter"><?php echo app('translator')->get('label.BRANCH'); ?></th>
                            <th class="text-center vcenter"><?php echo app('translator')->get('label.ALLOWED_FOR_SALES'); ?></th>
                            <th class="text-center vcenter"><?php echo app('translator')->get('label.AUTHORISED_FOR_REALIZATION_PRICE'); ?></th>
                            <th class="text-center vcenter"><?php echo app('translator')->get('label.ALLOWED_FOR_CRM'); ?></th>
                            <th class="text-center vcenter"><?php echo app('translator')->get('label.FOR_CRM_LEADER'); ?></th>
                            <th class="text-center vcenter"><?php echo app('translator')->get('label.ALLOWED_FOR_VIEW_QUOTATION_REQUSET'); ?></th>
                            <th class="text-center vcenter"><?php echo app('translator')->get('label.ALLOWED_FOR_MESSAGING'); ?></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="vcenter"><?php echo e($target->branch_name); ?></td>
                            <td class="text-center vcenter">
                                <?php if($target->allowed_for_sales == '1'): ?>
                            ...
                            <td class="text-center vcenter">
                                <?php if($target->authorised_for_realization_price == '1'): ?>
                                <span class="label label-sm label-success"><?php echo app('translator')->get('label.YES'); ?></span>
                                <?php else: ?>
                                <span class="label label-sm label-warning"><?php echo app('translator')->get('label.NO'); ?></span>
                                <?php endif; ?>
                            ...
                            <td class="text-center vcenter">
                                <?php if($target->allowed_for_crm == '1'): ?>
                                <span class="label label-sm label-success"><?php echo app('translator')->get('label.YES'); ?></span>
                                <?php else: ?>
                                <span class="label label-sm label-warning"><?php echo app('translator')->get('label.NO'); ?></span>
                                <?php endif; ?>
                            ...
                            <td class="text-center vcenter">
                                <?php if($target->for_crm_leader == '1'): ?>
                                <span class="label label-sm label-success"><?php echo app('translator')->get('label.YES'); ?></span>
                                <?php else: ?>
                                <span class="label label-sm label-warning"><?php echo app('translator')->get('label.NO'); ?></span>
                                <?php endif; ?>
                            ...
                            <td class="text-center vcenter">
                                <?php if($target->allowed_to_view_quotation == '1'): ?>
                                <span class="label label-sm label-success"><?php echo app('translator')->get('label.YES'); ?></span>
                                <?php else: ?>
                                <span class="label label-sm label-warning"><?php echo app('translator')->get('label.NO'); ?></span>
                                <?php endif; ?>
                            ...
                            <td class="text-center vcenter">
                                <?php if($target->allowed_for_messaging == '1'): ?>
                                <span class="label label-sm label-success"><?php echo app('translator')->get('label.YES'); ?></span>
                                <?php else: ?>
                                <span class="label label-sm label-warning"><?php echo app('translator')->get('label.NO'); ?></span>
                                <?php endif; ?>
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp_7_4_15\htdocs\konitaPower\resources\views/user/index.blade.php ENDPATH**/ ?>