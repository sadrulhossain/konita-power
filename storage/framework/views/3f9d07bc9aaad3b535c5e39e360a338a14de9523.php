...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-bar-chart"></i><?php echo app('translator')->get('label.SUPPLIER_WISE_SALES_SUMMARY_REPORT'); ?>
            </div>
            <div class="actions">
                <span class="text-right">
                    <?php if(Request::get('generate') == 'true'): ?>
                    <?php if(!empty($userAccessArr[57][6])): ?>
                    ...
                    <?php endif; ?>
                    <?php if(!empty($userAccessArr[57][9])): ?>
        ...
        <div class="portlet-body">
            <?php echo Form::open(array('group' => 'form', 'url' => 'supplierWiseSalesSummaryReport/filter','class' => 'form-horizontal')); ?>
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp_7_4_15\htdocs\konitaPower\resources\views/report/supplierWiseSalesSummary/index.blade.php ENDPATH**/ ?>