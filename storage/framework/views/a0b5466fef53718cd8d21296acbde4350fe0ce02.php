...
<div class="portlet-body">
    ...
    <div class="row margin-top-10">
        <!--PRODUCT_PRICING BOX-->
        <?php if(Auth::user()->group_id == 1 || !empty($userAccessArr[15][1]) || !empty($hasRelationWithProduct)): ?>
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <a class="dashboard-stat-v2  dashboard-stat green-meadow tooltips" href="#productPricingModal" id="productPricingId" data-toggle="modal" title="<?php echo app('translator')->get('label.PRODUCT_PRICING'); ?>">
                <div class="visual">
        ...
        <!--PRODUCT PRICE SETUP-->
        <?php if(!empty($userAccessArr[15][8])): ?>
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <a class="dashboard-stat-v2  dashboard-stat yellow-mint tooltips" href="#setProductPricingModal" id="setProductPricingId" data-toggle="modal" title="<?php echo app('translator')->get('label.SET_PRODUCT_PRICING'); ?>">
                <div class="visual">
                ...
                <div class="details">
                    ...
                    <div class="desc"><?php echo app('translator')->get('label.SET_PRODUCT_PRICING'); ?></div>
                </div>
            </a>
        </div>
        <?php endif; ?>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="dashboard-stat-v2  dashboard-stat blue-dark tooltips"  title="<?php echo app('translator')->get('label.KONITA_MONTHLY_NET_INCOME'); ?>">
                <div class="visual">
                    <i class="fa fa-dollar"></i>
                </div>
                <div class="details">
                    <div class="number">
                        <i class="fa fa-dollar"></i>
                        <span class="bold" data-counter="counterup" data-value="<?php echo e(!empty($monthlyNetIncome)?Helper::numberFormat2Digit($monthlyNetIncome):Helper::numberFormat2Digit(0)); ?>">
                            <?php echo e(!empty($monthlyNetIncome)?Helper::numberFormat2Digit($monthlyNetIncome):Helper::numberFormat2Digit(0)); ?>

                        </span>
                    </div>
                    <div class="desc font-size-15"><?php echo app('translator')->get('label.KONITA_MONTHLY_NET_INCOME'); ?></div>
                </div>
            </div>
        </div> 
        <?php endif; ?>
        ...
        <?php if(Auth::user()->allowed_for_sales=='1'): ?>
        <!--        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat-v2  dashboard-stat blue-dark tooltips"  title="<?php echo app('translator')->get('label.MY_SALES_COMMISSION'); ?>">
                        <div class="visual">
                            <i class="fa fa-dollar"></i>
                        </div>
                        <div class="details">
                            <div class="number">
                                <i class="fa fa-dollar"></i>
                                <span class="bold" data-counter="counterup" data-value="<?php echo e(!empty($myCurrentMonthCmsnData)?Helper::numberFormat2Digit($myCurrentMonthCmsnData):Helper::numberFormat2Digit(0)); ?>">
                                    <?php echo e(!empty($myCurrentMonthCmsnData)?Helper::numberFormat2Digit($myCurrentMonthCmsnData):Helper::numberFormat2Digit(0)); ?>

                                </span>
                            </div>
                            <div class="desc font-size-15"><?php echo app('translator')->get('label.MY_SALES_COMMISSION'); ?></div>
                        </div>
                    </div>
                </div> -->
        <?php endif; ?>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <a class="dashboard-stat-v2  dashboard-stat yellow-gold tooltips" href="#pendingLcModal" id="pendingLcId" data-toggle="modal" title="<?php echo app('translator')->get('label.CLICK_HERE_TO_VIEW_PENDING_FOR_LC'); ?>">
                <div class="visual">
                ...
                <div class="details">
                    <div class="number">
                        <!--<i class="fa fa-dollar"></i>-->
                        <span class="bold" data-counter="counterup" data-value="<?php echo e($pendingForLc); ?>">
                            <?php echo e($pendingForLc); ?>

                        </span>
                    </div>
                    <div class="desc"><?php echo app('translator')->get('label.PENDING_FOR_LC'); ?></div>
                </div>
            </a>
        </div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <a class="dashboard-stat-v2  dashboard-stat purple-studio tooltips" href="#pendingShipmentModal" id="pendingShipmentId" data-toggle="modal" title="<?php echo app('translator')->get('label.CLICK_HERE_TO_VIEW_PENDING_FOR_SHIPMENT'); ?>">
                <div class="visual">
                ...
                <div class="details">
                    <div class="number">
                        <!--<i class="fa fa-dollar"></i>-->
                        <span class="bold" data-counter="counterup" data-value="<?php echo e($pendingForShipment); ?>">
                            <?php echo e($pendingForShipment); ?>

                        </span>
                    </div>
                    <div class="desc"><?php echo app('translator')->get('label.PENDING_FOR_SHIPMENT'); ?></div>
                </div>
            </a>
        </div>
        ...
        <!--*** PARTIALLY SHIPPED-->
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <a class="dashboard-stat-v2  dashboard-stat blue-madison tooltips" href="#partiallyShippedModal" id="partiallyShippedId" data-toggle="modal" title="<?php echo app('translator')->get('label.CLICK_HERE_TO_VIEW_PARTIALLY_SHIPPED'); ?>">
                <div class="visual">
                    <i class="fa fa-ship"></i>
                </div>
                <div class="details">
                    <div class="number">
                        <!--<i class="fa fa-dollar"></i>-->
                        <span class="bold" data-counter="counterup" data-value="<?php echo e($partiallyShippedCount); ?>">
                            <?php echo e($partiallyShippedCount); ?>

                        </span>
                    </div>
                    <div class="desc"><?php echo app('translator')->get('label.PARTIALLY_SHIPPED'); ?></div>
                </div>
            </a>
        </div>
        ...
        <?php if(!empty($userAccessArr[27][5]) || !empty($userAccessArr[31][5])): ?>
        <!--*** Waiting for Tracking No-->
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <a class="dashboard-stat-v2  dashboard-stat red-haze tooltips" href="#trackingNoModal" id="trackingNoId" data-toggle="modal"  title="<?php echo app('translator')->get('label.CLICK_HERE_TO_VIEW_WAITING_FOR_TRACKING_NO'); ?>">
                <div class="visual">
                ...
                <div class="details">
                    <div class="number">
                        <!--<i class="fa fa-dollar"></i>-->
                        <span class="bold" data-counter="counterup" data-value="<?php echo e($waitingTrackingNoCount); ?>">
                            <?php echo e($waitingTrackingNoCount); ?>

                        </span>
                    </div>
                    <div class="desc"><?php echo app('translator')->get('label.WAITING_FOR_TRACKING_NO'); ?></div>
                </div>
            </a>
        </div>
        ...
        <?php if(Auth::user()->group_id == '1'): ?>
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="dashboard-stat-v2  dashboard-stat blue-dark tooltips"  title="<?php echo app('translator')->get('label.EXPECTED_INCOME'); ?>">
                <div class="visual">
                    <i class="fa fa-dollar"></i>
                </div>
                <div class="details">
                    <div class="number">
                        <i class="fa fa-dollar"></i>
                        <span class="bold" data-counter="counterup" data-value="<?php echo e(!empty($expectedIncome)?Helper::numberFormat2Digit($expectedIncome):Helper::numberFormat2Digit(0)); ?>">
                            <?php echo e(!empty($expectedIncome)?Helper::numberFormat2Digit($expectedIncome):Helper::numberFormat2Digit(0)); ?>

                        </span>
                    </div>
                    <div class="desc font-size-15"><?php echo app('translator')->get('label.EXPECTED_INCOME'); ?></div>
                </div>
            </div>
        </div> 
        <?php endif; ?>
                ...
                <div class="portlet-title">
                    <div class="caption">
                        <span class="caption-subject bold uppercase font-dark">
                            <?php echo app('translator')->get('label.CRM_STATUS_SUMMARY'); ?>
                        </span>
                        <span class="caption-helper"></span>
                    </div>
                    <div class="actions">
                        <?php if(Auth::user()->for_crm_leader == '1' || Auth::user()->group_id=='1'): ?>
                        <a class="btn btn-circle btn-default" href="<?php echo e(URL::to('crmAllOpportunity')); ?>"> See All </a>
                        <?php endif; ?>
                                ...
                                <table class="table table-hover table-head-fixer-color-grey-mint">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="vcenter text-center"><?php echo app('translator')->get('label.CRM_STATUS'); ?></th>
                                            <th class="vcenter text-center"><?php echo app('translator')->get('label.THIS_WEEK'); ?></th>
                                            <th class="vcenter text-center"><?php echo app('translator')->get('label.TODAY'); ?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php $crmStatusSummarySl = 0; ?>
                                        <tr>
                                            <?php echo $__env->make('admin.others.crmStatusTableRows', [
...
<!--                                        <tr>
        ...
        <div class="col-md-6 col-sm-12 col-xs-12 margin-top-10">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        <span class="caption-subject bold uppercase font-dark">
                            <?php echo app('translator')->get('label.CRM_ACTIVITY_SCHEDULE'); ?>
                        </span>
                        <span class="caption-helper"></span>
                    </div>
                    <div class="actions">
    ...
    <div class="row">
        ...
        <!--**************************SALES PERSONS PART START******************************-->
        <?php if(Auth::user()->allowed_for_sales=='1' || Auth::user()->group_id=='1'): ?>
        <!--Team Performance (Current Month)-->
        <?php if(array_key_exists(Auth::user()->id,$teamSupervisorArr)): ?>
        <div class="col-md-6 col-sm-12 col-xs-12 margin-top-10">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        <span class="caption-subject bold uppercase font-dark">
                            <?php echo app('translator')->get('label.TEAM_PERFORMANCE_CURRENT_MONTHS'); ?>
                        </span>
                        <span class="caption-helper"></span>
                    </div>
                    <div class="actions">
        ...
        <div class="col-md-6 col-sm-12 col-xs-12 margin-top-10">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        <span class="caption-subject bold uppercase font-dark">
                            <?php echo app('translator')->get('label.MY_PERFORMANCE_LAST_SIX_MONTHS'); ?>
                        </span>
                        <span class="caption-helper"></span>
                    </div>
                    <div class="actions">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 margin-top-10">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        <span class="caption-subject bold uppercase font-dark">
                            <?php echo app('translator')->get('label.TEAM_PERFORMANCE_LAST_SIX_MONTHS'); ?>
                        </span>
                        <span class="caption-helper"></span>
                    </div>
                    <div class="actions">
        ...
        <?php if(!empty($userAccessArr[23][1]) || Auth::user()->group_id=='1'): ?>
        <div class="col-md-12 col-sm-12 col-xs-12 margin-top-10">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        <span class="caption-subject bold uppercase font-dark">
                            <?php echo app('translator')->get('label.INQUIRY_SUMMARY_LAST_30_DAYS'); ?>
                        </span>
                        <span class="caption-helper"></span>
                    </div>
                    <div class="actions">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 margin-top-10">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        <span class="caption-subject bold uppercase font-dark">
                            <?php echo app('translator')->get('label.MY_SALES_STATUS'); ?>&nbsp;(<?php echo e($showLast12Month.' ' .'-'.' '. $showCurrentDay); ?>)
                        </span>
                        <span class="caption-helper"></span>
                    </div>
                    <div class="actions">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 margin-top-10">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        <span class="caption-subject bold uppercase font-dark">
                            <?php echo app('translator')->get('label.SALES_STATUS_TEAM'); ?>&nbsp;(<?php echo e($showLast12Month.' ' .'-'.' '. $showCurrentDay); ?>)
                        </span>
                        <span class="caption-helper"></span>
                    </div>
                    <div class="actions">
                    ...
                    <div class="row text-center">
                        <div class="col-md-3 margin-top-10 margin-bottom-10">
                            <a href="#buyerDetailsModal" id="buyerModalId" data-toggle="modal">
                                <span class="dashboard-circle-1 tooltips" title="<?php echo app('translator')->get('label.CLICK_HERE_TO_VIEW_BUYER'); ?>">
                                    <div data-counter="counterup" data-value="<?php echo e($myBuyerCount); ?>" class="number-style"><?php echo e($myBuyerCount); ?></div>
                                </span>
                            </a>  
                            <div class="bold margin-top-20 font-size-15"><?php echo app('translator')->get('label.BUYER'); ?></div>
                        </div>
                        <div class="col-md-3 margin-top-10 margin-bottom-10">
                            <a href="#productDetailsModal" id="productModalId" data-toggle="modal">
                                <span class="dashboard-circle-2 tooltips" title="<?php echo app('translator')->get('label.CLICK_HERE_TO_VIEW_PRODUCT'); ?>">
                                    <div data-counter="counterup" data-value="<?php echo e(count($myProductArr)); ?>" class="number-style"><?php echo e(count($myProductArr)); ?></div>
                                </span>
                            </a>
                            <div class="bold margin-top-20 font-size-15"><?php echo app('translator')->get('label.PRODUCT'); ?></div>
                        </div>
                        <div class="col-md-3 margin-top-10 margin-bottom-10">
                            <a href="#brandDetailsModal" id="brandModalId" data-toggle="modal">
                                <span class="dashboard-circle-3 tooltips" title="<?php echo app('translator')->get('label.CLICK_HERE_TO_VIEW_BRAND'); ?>">
                                    <div data-counter="counterup" data-value="<?php echo e(count($myBrandCount)); ?>" class="number-style"><?php echo e(count($myBrandCount)); ?></div>
                                </span>  
                            </a>
                            <div class="bold margin-top-20 font-size-15"><?php echo app('translator')->get('label.BRAND'); ?></div>
                        </div>
                        <div class="col-md-3 margin-top-10 margin-bottom-10">
                            <a href="#salesPersonsModal" id="salesPersonsModalId" data-toggle="modal">
                                <span class="dashboard-circle-4 tooltips" title="<?php echo app('translator')->get('label.CLICK_HERE_TO_VIEW_SALES_PERSONS'); ?>">
                                    <div data-counter="counterup" data-value="<?php echo e(count($salesPersonCount)); ?>" class="number-style"><?php echo e(count($salesPersonCount)); ?></div>
                                </span>  
                            </a>
                            <div class="bold margin-top-20 font-size-15"><?php echo app('translator')->get('label.SALES_PERSON'); ?></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        ...
        <?php if(!empty($userAccessArr[27][1]) || !empty($userAccessArr[31][1])): ?>
        ...
        <div class="col-md-6 col-sm-12 col-xs-12 margin-top-10">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        <span class="caption-subject bold uppercase font-dark">
                            <?php echo app('translator')->get('label.NEXT_15_DAYS_ETS_SUMMARY'); ?>
                        </span>
                        <span class="caption-helper"></span>
                    </div>
                    <div class="actions">
        ...
        <div class="col-md-6 col-sm-12 col-xs-12 margin-top-10">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        <span class="caption-subject bold uppercase font-dark">
                            <?php echo app('translator')->get('label.NEXT_15_DAYS_ETA_SUMMARY'); ?>
                        </span>
                        <span class="caption-helper"></span>
                    </div>
                    <div class="actions">
        ...
        <div class="col-md-6 col-sm-12 col-xs-12 margin-top-10">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        <span class="caption-subject bold uppercase font-dark">
                            <?php echo app('translator')->get('label.TOP_10_SUPPLIER_WITH_PAYMENT_DUE'); ?>
                        </span>
                        <span class="caption-helper"></span>
                    </div>
                    <div class="actions">
                        <a class="btn btn-circle btn-default" href="<?php echo e(URL::to('supplierLedger')); ?>"> See All </a>
                        <a class="btn btn-circle btn-icon-only btn-default fullscreen" href="#" data-original-title="" title=""> </a>
                    </div>
                </div>
                <div class="portlet-body">
        ...
        <div class="col-md-6 col-sm-12 col-xs-12 margin-top-10">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        <span class="caption-subject bold uppercase font-dark">
                            <?php echo app('translator')->get('label.TOP_10_BUYER_WITH_PAYMENT_DUE'); ?>&nbsp;(<?php echo app('translator')->get('label.RECEIVABLE'); ?>)
                        </span>
                        <span class="caption-helper"></span>
                    </div>
                    <div class="actions">
                        <a class="btn btn-circle btn-default" href="<?php echo e(URL::to('paymentStatus')); ?>"> See All </a>
                        <a class="btn btn-circle btn-icon-only btn-default fullscreen" href="#" data-original-title="" title=""> </a>
                    </div>
                </div>
                <div class="portlet-body">
        ...
        <div class="col-md-6 col-sm-12 col-xs-12 margin-top-10">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        <span class="caption-subject bold uppercase font-dark">
                            <?php echo app('translator')->get('label.TOP_10_SALES_COMMSSION_DUE'); ?>
                        </span>
                        <span class="caption-helper"></span>
                    </div>
                    <div class="actions">
                        <a class="btn btn-circle btn-default" href="<?php echo e(URL::to('salesPersonLedger')); ?>"> See All </a>
                        <a class="btn btn-circle btn-icon-only btn-default fullscreen" href="#" data-original-title="" title=""> </a>
                    </div>
                </div>
                <div class="portlet-body">
        ...
        <div class="col-md-6 col-sm-12 col-xs-12 margin-top-10">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        <span class="caption-subject bold uppercase font-dark">
                            <?php echo app('translator')->get('label.TOP_10_BUYER_COMMSSION_DUE'); ?>
                        </span>
                        <span class="caption-helper"></span>
                    </div>
                    <div class="actions">
                        <a class="btn btn-circle btn-default" href="<?php echo e(URL::to('buyerLedger')); ?>"> See All </a>
                        <a class="btn btn-circle btn-icon-only btn-default fullscreen" href="#" data-original-title="" title=""> </a>
                    </div>
                </div>
                <div class="portlet-body">
...
e.preventDefault();
$.ajax({
url: "<?php echo e(URL::to('dashboard/productPricingView')); ?>",
        type: "POST",
        dataType: "json",
        headers: {
...
e.preventDefault();
$.ajax({
url: "<?php echo e(URL::to('/dashboard/showProductPricing')); ?>",
        type: "POST",
        dataType: "json",
        headers: {
        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
e.preventDefault();
$.ajax({
url: "<?php echo e(URL::to('dashboard/getAuthorizedUserBuyer')); ?>",
        type: "POST",
        dataType: "json",
        headers: {
        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
var name = $(".search").val();
$.ajax({
url: "<?php echo e(URL::to('dashboard/getAuthorizedUserBuyerByName')); ?>",
        type: "POST",
        dataType: "json",
        headers: {
        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
e.preventDefault();
$.ajax({
url: "<?php echo e(URL::to('dashboard/getAllAuthorizedUserBuyer')); ?>",
        type: "POST",
        dataType: "json",
        headers: {
        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
e.preventDefault();
$.ajax({
url: "<?php echo e(URL::to('dashboard/getAuthorizedUserProduct')); ?>",
        type: "POST",
        dataType: "json",
        headers: {
        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
e.preventDefault();
$.ajax({
url: "<?php echo e(URL::to('dashboard/getAuthorizedUserBrand')); ?>",
        type: "POST",
        dataType: "json",
        headers: {
        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
e.preventDefault();
$.ajax({
url: "<?php echo e(URL::to('dashboard/getSalesPersons')); ?>",
        type: "POST",
        dataType: "json",
        headers: {
        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
?>
        ...
        {
        name: "<?php echo app('translator')->get('label.ACHIEVEMENT'); ?>",
                data: [
<?php
if (!empty($myLastSixMonthTagAcivArr)) {
    foreach ($myLastSixMonthTagAcivArr as $achiev) {
        ?>
                        "<?php echo e($achiev['achievement']); ?>",
        <?php
    }
}
?>
...
foreach ($salesPersonLastSixMonthArr as $salesPersonId => $salesPersonName) {
    ?>
            {
            name: "<?php echo e($salesPersonName); ?>",
                    data: [
    <?php
...
?>
        ...
        yaxis: {
        title: {
        text: "<?php echo app('translator')->get('label.PERFORMANCE_PERCENTAGE'); ?>"
        }
        },
        tooltip: {
        y: {
...
if (!empty($salesPersonCurrentMonthArr)) {
    foreach ($salesPersonCurrentMonthArr as $userId => $salesPersonName) {
        ...
        ?>
        achieveArr.push(<?php echo e($achieve); ?>);
        targetArr.push(<?php echo e($target); ?>);
        <?php
    }
}
?>
...
type: 'bar',
        ...
        series: [{
        name: "<?php echo app('translator')->get('label.PERFORMANCE'); ?>",
                data: [
<?php
if (!empty($salesPersonCurrentMonthArr)) {
    foreach ($salesPersonCurrentMonthArr as $userId => $salesPersonName) {
        ...
        ?>
                        "<?php echo e($currentMonthAchivpercent); ?>",
        <?php
    }
}
?>
...
?>
                ...
                title: {
                text: "<?php echo app('translator')->get('label.SALES_PERSONS'); ?>",
                        offsetX: 0,
                        offsetY: 0,
                        style: {
                        color: undefined,
...
?>
        ...
        {
        name: "<?php echo app('translator')->get('label.PIPE_LINE'); ?>",
                data: [
<?php
if (!empty($myBrandArr)) {
    foreach ($myBrandArr as $brandId => $braName) {
...
?>
        ...
        {
        name: "<?php echo app('translator')->get('label.CONFIRMED'); ?>",
                data: [
<?php
if (!empty($myBrandArr)) {
    foreach ($myBrandArr as $brandId => $braName) {
...
?>
        ...
        {
        name: "<?php echo app('translator')->get('label.ACCOMPLISHED'); ?>",
                data: [
<?php
if (!empty($myBrandArr)) {
    foreach ($myBrandArr as $brandId => $braName) {
...
type: 'bar',
        ...
        $.ajax({
        url: "<?php echo e(URL::to('dashboard/getEtsSummary')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        series: [{
        name: "<?php echo app('translator')->get('label.NO_OF_SHIPMENT'); ?>",
                data: [
<?php
...
?>
        ...
        yaxis: {
        title: {
        text: "<?php echo app('translator')->get('label.NO_OF_SHIPMENT'); ?>"
        },
        },
        fill: {
        type: 'gradient',
...
type: 'bar',
        ...
        var dateIndex = config.dataPointIndex;
        $.ajax({
        url: "<?php echo e(URL::to('dashboard/getEtaSummary')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
type: 'bar',
        ...
        var dateIndex = config.dataPointIndex;
        $.ajax({
        url: "<?php echo e(URL::to('dashboard/getInquirySummary')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        series: [{
        name: "<?php echo app('translator')->get('label.VOLUME'); ?>",
                data: [
<?php
...
type: 'bar',
        ...
        series: [{
        name: "<?php echo app('translator')->get('label.AMOUNTS'); ?>",
                data: [
<?php
...
?>
                ...
                title: {
                text: "<?php echo app('translator')->get('label.SUPPLIERS'); ?>",
                        offsetX: 0,
                        offsetY: 0,
                        style: {
                        color: undefined,
        ...
        yaxis: {
        title: {
        text: "<?php echo app('translator')->get('label.AMOUNTS'); ?> ($)"
        }
        },
        fill: {
        type: 'gradient',
...
?>
                ...
                title: {
                text: "<?php echo app('translator')->get('label.BUYERS'); ?>",
                        offsetX: 0,
                        offsetY: 0,
                        style: {
                        color: undefined,
...
?>
                ...
                title: {
                text: "<?php echo app('translator')->get('label.EMPLOYEES'); ?>",
                        offsetX: 0,
                        offsetY: 0,
                        style: {
                        color: undefined,
...
if (!empty($userAccessArr[80][17])) {
    ?>
            swal({
            title: "<?php echo app('translator')->get('label.ARE_YOU_SURE_YOU_WANT_TO_MARK_THIS_SCHEDULE_AS_DONE'); ?>",
                    type: 'warning',
            ...
            if (isConfirm) {
            $.ajax({
            url: "<?php echo e(URL::to('crmScheduleCalendar/scheduleDone')); ?>",
                    type: 'POST',
                    dataType: 'json',
                    data: {
...
?>
        ...
        events: [
                <?php $__currentLoopData = $activityEventArr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        {
        title: "<?php echo $event['title'].'\n'.Helper::trimString($event['purpose']); ?>",
                start: "<?php echo $event['start_date']; ?>",
                description:"<?php echo 'Buyer : '.$opportunityArr[$event['opportunity_id']]. '<br/>Schedule Created By : ' . $event['schedule_creator'] . '<br/>Status : <span class=\"label label-sm bold label-' .$event['color'].' \">' . $event['status'] .'</span><br />Schedule Date/Time : '.Helper::formatDateTime($event['start_date']).'<br />Schedule Purpose : '.$event['purpose']; ?>",
                popTitle: "<?php echo 'Date: '.$event['title']; ?>",
                color: "<?php echo !empty($event['schedule_status']) && $event['schedule_status'] == 1 ? '#1BA39C' : '#525E64'; ?>",
                opportunity: "<?php echo $event['opportunity_id']; ?>",
                activityKey: "<?php echo $key; ?>",
                scheduleStatus: "<?php echo $event['schedule_status']; ?>",
                scheduledone: "<?php echo $event['schedule_done_color']; ?>",
        },
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp_7_4_15\htdocs\konitaPower\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>