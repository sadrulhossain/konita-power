<div class="modal-content">
    <div class="modal-header clone-modal-header">
        ...
        <h4 class="modal-title text-center bold">
            <?php echo app('translator')->get('label.ASSIGN_SALES_PERSON'); ?>
        </h4>
    </div>
    <div class="modal-body">
        ...
        <div class="row margin-top-10">
            <div class="col-md-12">
                <?php echo Form::hidden('buyer_id', $request->buyer_id); ?>
                ...
                <div class="table-responsive max-height-500 webkit-scrollbar">
                    <table class="table table-bordered table-hover table-head-fixer-color">
                        ...
                        <tbody>
                            ...
                            <?php $sl = 0; ?>
                            <?php $__currentLoopData = $salesPersonInfoArr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="text-center vcenter"><?php echo ++$sl; ?></td>
                                <td class="vcenter">
                                    <div class="md-checkbox has-success">
                                        <?php echo Form::checkbox('sales_person['.$item->id.']', $item->id, false, ['id' => $item->id, 'data-id'=> $item->id,'class'=> 'md-check sp-check']); ?>
                                ...
                                <td class="vcenter"><?php echo $item->name ?? ''; ?></td>
                            ...
                            <?php else: ?>
                            <tr>
                                <td class="vcenter text-danger" colspan="9"><?php echo app('translator')->get('label.NO_DATA_FOUND'); ?></td>
                            </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
    ...
    <div class="modal-footer">
        ...
        <button class="btn green set-assign-sales-person" id="setAssignSalesPerson" type="button">
            <i class="fa fa-check"></i> <?php echo app('translator')->get('label.ASSIGN'); ?>
        </button>
        <?php endif; ?>
...
</script><?php /**PATH E:\xampp_7_4_15\htdocs\konitaPower\resources\views/report/buyerSummary/showAssignSalesPerson.blade.php ENDPATH**/ ?>