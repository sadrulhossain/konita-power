...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-bar-chart"></i><?php echo app('translator')->get('label.BRAND_WISE_SALES_SUMMARY_REPORT'); ?>
            </div>
            <div class="actions">
        ...
        <div class="portlet-body">
            <?php echo Form::open(array('group' => 'form', 'url' => 'brandWiseSalesSummaryReport/filter','class' => 'form-horizontal')); ?>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            ...
                            <?php echo Form::select('product[]', $productList, $productArr, ['class' => 'form-control mt-multiselect btn btn-default', 'id' => 'product', 'multiple' => 'multiple', 'data-width' => '100%']); ?>
                    ...
                    <div class="max-height-500 tableFixHead sample webkit-scrollbar">
                        <table class="table table-bordered table-hover table-head-fixer-color" id="fixTable">
                            ...
                            <tbody>
                                ...
                                $sl = 0;
                                ?>
                                <?php $__currentLoopData = $brandList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brandId => $brandName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="text-center vcenter"><?php echo ++$sl; ?></td>
                                    <td class="text-center vcenter" width="40px">
                                        <?php if(!empty($brandLogoList[$brandId]) && File::exists('public/uploads/brand/'. $brandLogoList[$brandId])): ?>
                                        <img class="pictogram-min-space tooltips" width="40" height="40" src="<?php echo e(URL::to('/')); ?>/public/uploads/brand/<?php echo e($brandLogoList[$brandId]); ?>" alt="<?php echo e($brandName); ?>" title="<?php echo e($brandName); ?>"/>
                                        <?php else: ?> 
                                        <img width="40" height="40" src="<?php echo e(URL::to('/')); ?>/public/img/no_image.png" alt="<?php echo e($brandName); ?>"/>
                                        <?php endif; ?>
                                    </td>
                                    <td class="vcenter"><?php echo $brandName; ?></td>
                                    <td class="text-right vcenter"><?php echo (!empty($salesSummaryArr[$brandId]['volume']) ? Helper::numberFormat2Digit($salesSummaryArr[$brandId]['volume']) : Helper::numberFormat2Digit(0)) . ' ' . __('label.UNIT'); ?></td>
                                    <td class="text-right vcenter"><?php echo '$' . (!empty($salesSummaryArr[$brandId]['net_income']) ? Helper::numberFormat2Digit($salesSummaryArr[$brandId]['net_income']) : Helper::numberFormat2Digit(0)); ?></td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <th class="text-right vcenter" colspan="3"><?php echo app('translator')->get('label.TOTAL'); ?></th>
                                ...
                                <?php else: ?>
                                <tr>
                                    <td class="vcenter text-danger" colspan="5"><?php echo app('translator')->get('label.NO_DATA_FOUND'); ?></td>
                                </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
...
$(function () {
    ...
    $('#product').multiselect({
        ...
        buttonWidth: '194px',
        nonSelectedText: "<?php echo app('translator')->get('label.SELECT_PRODUCT'); ?>",
...
?>
            ...
            title: {
                text: "<?php echo app('translator')->get('label.BRANDS'); ?>",
                offsetX: -40,
                offsetY: -5,
                style: {
                    color: undefined,
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp_7_4_15\htdocs\konitaPower\resources\views/report/brandWiseSalesSummary/index.blade.php ENDPATH**/ ?>