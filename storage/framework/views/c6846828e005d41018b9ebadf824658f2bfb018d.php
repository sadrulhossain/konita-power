...
<div class="col-md-12">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-user"></i><?php echo app('translator')->get('label.EDIT_BUYER'); ?>
            </div>
        </div>
        <div class="portlet-body form">
            <?php echo Form::model($target, ['files'=> true, 'class' => 'form-horizontal', 'id' => 'buyerEditForm'] ); ?>
            ...
            <div class="form-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <?php echo Form::select('country_id', $countryList, null, ['class' => 'form-control js-source-states', 'id' => 'countryId']); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <?php echo Form::text('username', !empty($user->username) ? $user->username : '', ['id'=> 'userName', 'class' => 'form-control','autocomplete' => 'off']); ?> 
                        ...
                        <div class="col-md-5">
                                ...
                                <div class="col-md-8">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                            ...
                                            <img src="<?php echo e(URL::to('/')); ?>/public/uploads/buyer/<?php echo e($target->logo); ?>" alt="<?php echo e($target->name); ?>"/>
                                            <?php else: ?>
                                        ...
                                        <div>
                                            ...
                                            <span class="help-block text-danger"><?php echo $errors->first('logo'); ?></span>
                                            <a href="javascript:;" class="btn red fileinput-exists" data-dismiss="fileinput"> <?php echo app('translator')->get('label.REMOVE'); ?> </a>
                                        </div>
                                    </div>
                                    <div class="clearfix margin-top-10">
                                        <span class="label label-danger"><?php echo app('translator')->get('label.NOTE'); ?></span><span class="text-danger bold"><?php echo app('translator')->get('label.SUPPLIER_IMAGE_FOR_IMAGE_DESCRIPTION'); ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-md-12 map-view width-420">
                                    <?php echo $target->gmap_embed_code; ?>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                <?php echo Form::hidden('add_btn', '1', ['id' => 'addBtn']); ?>
                                ...
                                $v4 = 'z' . uniqid();
                                ?>
                                <?php if(!empty($prevContactPersonArr)): ?>
                                <?php
                                $count = 1;
                                ?>
                                <?php $__currentLoopData = $prevContactPersonArr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $identifier => $contactPerson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                <div class="col-md-12 contact-person-div">
                                    <div class="row">
                                        <?php if($count > 1): ?>
                                        <button class="btn btn-danger remove tooltips pull-right block-remove" data-count="<?php echo e($count); ?>" title="<?php echo app('translator')->get('label.CLICK_HERE_TO_DELETE_THIS_BLOCK'); ?>" type="button" 
                                                id="deleteBtn_"<?php echo e($count); ?>>
                                            &nbsp;<?php echo app('translator')->get('label.DELETE'); ?>&nbsp;<i class="fa fa-remove"></i>
                                        </button>
                                        <?php endif; ?>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-3 contact-div">
                                                    <?php echo Form::text('contact_name['.$identifier.']', $contactPerson['name'], ['id'=> 'contactName'.$identifier,'class' => 'focus-input']); ?> 
                                                    <label class="floating-label" id="spanName_<?php echo e($identifier); ?>"><?php echo app('translator')->get('label.NAME'); ?> <span class="text-danger"> *</span></label>
                                                </div>
                                                <div class="col-md-3 contact-div">
                                                    <?php echo Form::select('designation_id['.$identifier.']',$designationList, $contactPerson['designation_id'], ['class' => 'form-control designation-id js-source-states', 'id' => 'designationId'.$identifier,'data-width' => '100%']); ?> 
                                                    <label class="floating-label" id="spanDeg_<?php echo e($identifier); ?>"><?php echo app('translator')->get('label.DESIGNATION'); ?> </label>
                                                </div>
                                                <div class="col-md-3 contact-div">
                                                    <?php echo Form::email('contact_email['.$identifier.']', $contactPerson['email'], ['id'=> 'contactEmail'.$identifier,'class' => 'focus-input']); ?>

                                                    <label class="floating-label" id="spanEmail_<?php echo e($identifier); ?>"><?php echo app('translator')->get('label.EMAIL'); ?> <span class="text-danger"> *</span></label>
                                                </div>
                                                <div class="col-md-3 contact-div">
                                                    <?php echo Form::textarea('special_note['.$identifier.']', $contactPerson['note'], ['id'=> 'specialNote'.$identifier, 'class' => 'focus-input', 'autocomplete' => 'off', 'size' => '40x1' ]); ?> 
                                                    <label class="floating-label" id="spanNote_<?php echo e($identifier); ?>"><?php echo app('translator')->get('label.CONTACT_NOTE'); ?></label>
                                                </div>

                                            </div>
                                            <br/>
                                            <div class="row">
                                                <?php if(is_array($contactPerson['phone'])): ?>
                                                <?php
                                                $i = 1;
                                                ?>
                                                <?php $__currentLoopData = $contactPerson['phone']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($i==1): ?>
                                                <div class="col-md-3  contact-div">
                                                    <?php echo Form::text('contact_phone['.$identifier.']['.$key.']', $contact, ['id'=> 'contactPhone'.$identifier,'class' => 'integer-only focus-input']); ?> 
                                                    <label class="floating-label" id="spanPhone_<?php echo e($identifier); ?>"><?php echo app('translator')->get('label.PHONE'); ?> <span class="text-danger"> *</span></label>
                                                </div>
                                                <div class="col-md-1 margin-top-10">
                                                    <button class="btn btn-inline green-haze add-phone-number tooltips" data-key="<?php echo e($identifier); ?>" data-placement="right" title="<?php echo app('translator')->get('label.ADD_NEW_PHONE_NUMBER'); ?>" type="button">
                                                ...
                                                <?php else: ?>
                                                <div class="col-md-3  contact-div">
                                                    <?php echo Form::text('contact_phone['.$identifier.']['.$v4.']',!empty($contactPerson['phone'])?$contactPerson['phone']:null, ['id'=> 'contactPhone'.$identifier,'class' => 'integer-only focus-input']); ?> 
                                                    <label class="floating-label" id="spanPhone_<?php echo e($identifier); ?>"><?php echo app('translator')->get('label.PHONE'); ?> <span class="text-danger"> *</span></label>
                                                </div>
                                                <div class="col-md-1 margin-top-10">
                                                    <button class="btn btn-inline green-haze add-phone-number tooltips" data-key="<?php echo e($identifier); ?>" data-placement="right" title="<?php echo app('translator')->get('label.ADD_NEW_PHONE_NUMBER'); ?>" type="button">
                                                ...
                                                <?php endif; ?>
                                                <div id="addPhoneNumberRow<?php echo e($identifier); ?>"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="">
                                    ...
                                    <div class="col-md-12 contact-person-div">
                                        <!--                                    <div class="row">
                                                                                <button class="btn btn-danger remove tooltips pull-right block-remove" title="<?php echo app('translator')->get('label.CLICK_HERE_TO_DELETE_THIS_BLOCK'); ?>" type="button">
                                                                                    &nbsp;<?php echo app('translator')->get('label.DELETE'); ?>&nbsp;<i class="fa fa-remove"></i>
                                                                                </button>
                                                                            </div>-->
                                        <div class="col-md-12">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on("click", ".add-contact-person", function () {
            $.ajax({
                url: "<?php echo e(route('buyer.editContactPerson')); ?>",
                type: "POST",
        ...
        $(document).on("click", "#submitEditBuyer", function (e) {
            ...
            $.ajax({
                url: "<?php echo e(route('buyer.update')); ?>",
                type: "POST",
                dataType: 'json', // what to expect back from the PHP script, if anything
                cache: false,
                contentType: false,
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp_7_4_15\htdocs\konitaPower\resources\views/buyer/edit.blade.php ENDPATH**/ ?>