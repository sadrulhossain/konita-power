<div class="modal-content">
    <div class="modal-header clone-modal-header">
        ...
        <?php if($userAccessArr[59][6]): ?>
        <a class="btn green-haze pull-right tooltips vcenter margin-left-right-5" target="_blank" href="<?php echo e(URL::to('transferBuyerToSalesPerson/getRelatedSalesPersonListPrint?buyer_id='.Request::get('buyer_id').'&view=print')); ?>"  title="<?php echo app('translator')->get('label.CLICK_HERE_TO_PRINT'); ?>">
...
</script><?php /**PATH E:\xampp_7_4_15\htdocs\konitaPower\resources\views/transferBuyerToSalesPerson/showRelatedSalesPersonList.blade.php ENDPATH**/ ?>