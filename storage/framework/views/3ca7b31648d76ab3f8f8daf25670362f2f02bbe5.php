    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                ...
                <?php echo app('translator')->get('label.RW_BREAKDOWN_EDIT'); ?>
                <?php else: ?>
                <?php echo app('translator')->get('label.RW_BREAKDOWN'); ?>
                <?php endif; ?>
            </div>
            <div class="actions">
                <a href="<?php echo e(URL::to('/pendingOrder'.Helper::queryPageStr($qpArr))); ?>" class="btn btn-sm blue-dark">
        ...
        <div class="portlet-body">
            <div class="row">
                <!-- Begin Proced-->
                <?php echo Form::open(array('group' => 'form', 'url' => '#','class' => 'form-horizontal')); ?>

                <?php echo Form::hidden('inquiry_id', $target->id,['id' => 'inquiryId']); ?> 

                <div class="col-md-offset-2 col-md-4">
                    <div class="form-group">
                        <label class="control-label col-md-4" for="productId"><?php echo app('translator')->get('label.PRODUCT'); ?> :<span class="text-danger"> *</span></label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-4" for="brandId"><?php echo app('translator')->get('label.BRAND'); ?> :<span class="text-danger"> *</span></label>
                        <div class="col-md-8">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on('change', '#productId', function (e) {
            ...
            $('#showGrade').html('');
            $.ajax({
                url: "<?php echo e(URL::to('pendingOrder/rwBreakdownGetBrand')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
        ...
        $(document).on('change', '#brandId', function (e) {
            ...
            $('#showRwBreakdownView').html('');
            $.ajax({
                url: "<?php echo e(URL::to('pendingOrder/rwBreakdownGetGrade')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).on('change', '#gradeId', function (e) {
            ...
            $('#showRwBreakdownView').html('');
            $.ajax({
                url: "<?php echo e(URL::to('pendingOrder/getRwBreakdownView')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
// Serialize the form data
            ...
            $.ajax({
                url: "<?php echo e(URL::to('pendingOrder/rwProceedRequest')); ?>",
                type: "POST",
...
// Serialize the form data
            var formData = new FormData($('#proceedForm')[0]);
            $.ajax({
                url: "<?php echo e(URL::to('pendingOrder/rwProceedRequestEdit')); ?>",
                type: "POST",
                dataType: 'json', // what to expect back from the PHP script, if anything
                cache: false,
                contentType: false,
...
// Serialize the form data
            ...
            $.ajax({
                url: "<?php echo e(URL::to('pendingOrder/rwPreviewRequest')); ?>",
                type: "POST",
                dataType: 'json', // what to expect back from the PHP script, if anything
                cache: false,
                contentType: false,
...
// Serialize the form data
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        url: "<?php echo e(URL::to('pendingOrder/rwBreakDownSave')); ?>",
                        type: "POST",
                        dataType: 'json', // what to expect back from the PHP script, if anything
                        cache: false,
                        contentType: false,
...
// Serialize the form data
            ...
            $.ajax({
                url: "<?php echo e(URL::to('pendingOrder/getLeadRwParametersName')); ?>",
                type: "POST",
                dataType: 'json', // what to expect back from the PHP script, if anything
                data: {
                    rw_unit_id: rwParaId,
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp_7_4_15\htdocs\konitaPower\resources\views/pendingOrder/rwBreakdown/rwBreakdown.blade.php ENDPATH**/ ?>